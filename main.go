...
import (
	...
	"io/ioutil"
	"log"
	"protobuf-go/src/complex/complexpb"
	"protobuf-go/src/enum_example/enumpb"
	"protobuf-go/src/simple/simplepb"
...
func writeToFile(fname string, pb proto.Message) error {
	...
	if err != nil {
		log.Println("Can't serialise to bytes", err)
		return err
	}
...
func readFromFile(fname string, pb proto.Message) error {
	...
	if err != nil {
		log.Println("Couldn't put the bytes into the protocol buffers struct", err)
		return err
	}
